...
if (!isServerless || process.env.NODE_ENV !== 'test') {
  app.listen(PORT, function() {
    ...
    try { getMsgStoreDb(); } catch (e) { console.warn('MsgStore DB init gagal: ' + e.message); }
    startWhatsAppBot();
  });
} else {
  startWhatsAppBot();
